...
const whitespace = /[:\s,]/;
const symbolHead = /^[a-z]/i;
const symbolTail = /[a-z1-9-@_'%<>=&\$\.\+\*\!\?]/i;
// `.` `*` `+` `!` `-` `_` `?` `$` `%` `&` `=` `<` `>`.
const numeric = /[0-9]/;
...
exports.isNumeric = v => numeric.test(v);
exports.isNumericPoint = (value, cur, next) => cur && !value.includes('.') && numeric.test(next);
